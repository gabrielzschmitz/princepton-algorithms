/*
  ...
  44
  55
  Upon execution with the command `java-algs4 PercolationVisualizer input.txt`,
  the program will visualize the percolation process based on the specified grid
